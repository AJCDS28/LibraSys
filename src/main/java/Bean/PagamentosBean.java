...
public class PagamentosBean {
    ...
    public PagamentosBean(Long idPagamento, double valorPago, int status, Long idEmprestimo) {
    ...
    public PagamentosBean(Long idEmprestimo, double valorEmprestimo, double valorPago, String status) {
        this.idEmprestimo = idEmprestimo;
    ...
    public PagamentosBean(double valorPago, int status, Long idEmprestimo) {
        this.valorPago = valorPago;
        this.status = status;
        this.idEmprestimo = idEmprestimo;
    }
    
    public PagamentosBean(Long idPagamento, double valorPago) {
        this.valorPago = valorPago;
        this.idPagamento = idPagamento;
    }
